        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview 
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php if($this->uri->uri_string() == 'transaksi/chart'){ echo 'active';}?>">
                        <a href="<?php echo base_url("transaksi/chart");?>" class="cursor">
                            <span class="fa fa-pie-chart"></span> Grafik
                        </a>
                    </li>
                </ul>
            </li>
